...
<head>
	...
	<script type="text/javascript">
			...
			$(function(){
				$('#dg').datagrid({	
					url : "http://"+host+":8080/gtintelWS/rest/dataDic/getAddDicCaseList",
					iconCls	:	'icon-save',
					pagination	:	true,
					striped		:	true,
					showFooter	:	true,
	...
	<script type="text/javascript">
		...
		function accept(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/saveAddDic',
				type:	  'post',
				dataType: 'json',
				...
				success:  function(data){
					...
					location.replace("http://"+host+":8080/gtintelWS/adddictionary.jsp");
				},
				error:function(e){
					console.log(e);
				}
		...
		function update(){
			if (editIndex != undefined){
				...
				$.ajax({
					url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/updateAddDic',
					type:	  'post',
					dataType: 'json',
					data : {
						"CaseId":CaseId,
		...
		function submit(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/postAddDicReq',
				type:	  'get',
				dataType: 'json',
				data	:	"url="+url,
				success:  function(data){
...
<body>
	...
	<div style="margin-bottom:10px">
		<input id="url" class="easyui-textbox" data-options="prompt:'http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/Add'" style="width:50%;height:32px" value="http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/Add"><br/>
	</div>
...
<!-- 		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" onclick="getChanges()">GetChanges</a> -->
	...
	<sql:query var="rs" dataSource="${dataSource}">
		select * from t_adddatadictionary
	</sql:query>
