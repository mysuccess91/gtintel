...
<head>
	...
	<script type="text/javascript">
			...
			$(function(){
				$('#dg').datagrid({	
					url : "http://"+host+":8080/gtintelWS/rest/dataDic/getDelDicReqList",
					iconCls	:	'icon-save',
					pagination	:	true,
					striped		:	true,
					showFooter	:	true,
	...
	//var host = 'localhost'
		...
		function accept(){
			...
			var instanceId = index.instanceId;

			var postData ={
					"instanceId":instanceId
				};
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/addDelDic',
				type:	  'post',
				dataType: 'json',
				...
				success:  function(data){
					...
					location.replace("http://"+host+":8080/gtintelWS/deldictionary.jsp");
				},
				error:function(e){
					console.log(e);
				}
		...
		function update(){
			if (editIndex != undefined){
				...
				$.ajax({
					url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/editDelDic',
					type:	  'post',
					dataType: 'json',
					data : {
						"CaseId":CaseId,
		...
		function submit(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/getDelDicReq',
				type:	  'get',
				dataType: 'json',
				data	:	"url="+url,
				success:  function(data){
...
<body>
	...
	<div style="margin-bottom:10px">
		<input id="url" class="easyui-textbox" data-options="prompt:'http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/Delete'" style="width:50%;height:32px" value="http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/Delete"><br/>
	</div>
