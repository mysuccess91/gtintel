...
<head>
	...
	<script type="text/javascript">
			...
			$(function(){
				$('#dg').datagrid({	
					url : "http://"+host+":8080/gtintelWS/rest/dataDic/getGetDicReqList",
					iconCls	:	'icon-save',
					pagination	:	true,
					striped		:	true,
					showFooter	:	true,
	...
	//var host = 'localhost'
		...
		function accept(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/addGetDic',
				type:	  'post',
				dataType: 'json',
				...
				success:  function(data){
					...
					location.replace("http://"+host+":8080/gtintelWS/getdatadic.jsp");
				},
				error:function(e){
					console.log(e);
				}
		...
		function update(){
			if (editIndex != undefined){
				...
				$.ajax({
					url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/editGetDic',
					type:	  'post',
					dataType: 'json',
					data : {
						"CaseId":CaseId,
		...
		function submit(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/getGetDicReq',
				type:	  'get',
				dataType: 'json',
				data	:	"url="+url,
				success:  function(data){
...
<body>
	...
	<div style="margin-bottom:10px">
		<input id="url" class="easyui-textbox" data-options="prompt:'http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/Get'" style="width:50%;height:32px" value="http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/Get"><br/>
	</div>
