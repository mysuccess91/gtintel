...
<head>
	...
	//var host = 'localhost'
		...
		function accept(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/addGetDictionaries',
				type:	  'post',
				dataType: 'json',
				...
				success:  function(data){
					...
					location.replace("http://"+host+":8080/gtintelWS/getdictionaries.jsp");
				},
				error:function(e){
					console.log(e);
				}
		...
		function update(){
			...
			if (editIndex != undefined){
				...
				var search = index.search;
				$.ajax({
					url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/editGetDictinaries',
					type:	  'post',
					dataType: 'json',
					data : {
						"caseId" : caseId,
		...
		function submit(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/sendGetDictionaries',
				type:	  'get',
				dataType: 'text',
				data	:	"url="+url,
				success:  function(data){
...
<body>
	...
	<div style="margin-bottom:10px">
		<input id="url" class="easyui-textbox" data-options="prompt:'http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/GetDictionaries'" style="width:50%;height:32px" value="http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/GetDictionaries"><br/>
	</div>
...
<!-- 		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" onclick="getChanges()">GetChanges</a> -->
	...
	$(document).ready(function(){
		$('#dg').datagrid({
			url	:	"http://"+host+":8080/gtintelWS/rest/dataDic/getDictionaries",
			saveUrl : '',
			updateUrl : '',
			destroyUrl : "",
			//title	:	'basic demo',
