...
<head>
	...
	//var host = 'localhost'
		...
		function accept(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/addGetPageIds',
				type:	  'post',
				dataType: 'json',
				...
				success:  function(data){
					...
					location.replace("http://"+host+":8080/gtintelWS/getpageids.jsp");
				},
				error:function(e){
					console.log(e);
				}
		...
		function update(){
			...
			if (editIndex != undefined){
				...
				$.ajax({
					url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/editGetPageIds',
					type:	  'post',
					dataType: 'json',
					data : {
						"parentId" : parentId,
		...
		function submit(){
			...
			$.ajax({
				url :	  'http://'+host+':8080/gtintelWS/rest/dataDic/sendGetPageIds',
				type:	  'get',
				dataType: 'text',
				data	:	"url="+url,
				success:  function(data){
...
<body>
	...
	<div style="margin-bottom:10px">
		<input id="url" class="easyui-textbox" data-options="prompt:'http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/GetPageIds'" style="width:50%;height:32px" value="http://192.168.1.201:9001/gaeaapi/DataDictionaryInstance/GetPageIds"><br/>
	</div>
...
<!-- 		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" onclick="getChanges()">GetChanges</a> -->
	...
	$(document).ready(function(){
		$('#dg').datagrid({
			url	:	"http://"+host+":8080/gtintelWS/rest/dataDic/GetPageIdsList",
			saveUrl : '',
			updateUrl : '',
			destroyUrl : "",
			//title	:	'basic demo',
